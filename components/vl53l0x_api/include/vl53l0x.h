...
vl53l0x_err_t vl53l0x_set_tuning_settings(vl53l0x_handle_t dev, uint8_t* settings, bool use_internal);
vl53l0x_err_t vl53l0x_get_tuning_settings(vl53l0x_handle_t dev, uint8_t** settings, bool* use_internal);
...
vl53l0x_err_t vl53l0x_set_vcsel_pulse_period(vl53l0x_handle_t dev, vl53l0x_vcsel_period_type_t type, uint8_t period);
vl53l0x_err_t vl53l0x_get_vcsel_pulse_period(vl53l0x_handle_t dev, vl53l0x_vcsel_period_type_t type, uint8_t* period);
...
vl53l0x_err_t vl53l0x_set_seq_step_timeout(vl53l0x_handle_t dev, vl53l0x_seq_step_t step, fp1616_t timeout_ms);
vl53l0x_err_t vl53l0x_get_seq_step_timeout(vl53l0x_handle_t dev, vl53l0x_seq_step_t step, fp1616_t* timeout_ms);
...
vl53l0x_err_t vl53l0x_set_ref_calibration(vl53l0x_handle_t dev, uint8_t vhv_settings, uint8_t phase_calibration);
vl53l0x_err_t vl53l0x_get_ref_calibration(vl53l0x_handle_t dev, uint8_t* vhv_settings, uint8_t* phase_calibration);
...
vl53l0x_err_t vl53l0x_get_limit_check_status(vl53l0x_handle_t dev, vl53l0x_check_t check, bool* failed);
...
vl53l0x_err_t vl53l0x_set_limit_check_value(vl53l0x_handle_t dev, vl53l0x_check_t check, fp1616_t value);
vl53l0x_err_t vl53l0x_get_limit_check_value(vl53l0x_handle_t dev, vl53l0x_check_t check, fp1616_t* value);
vl53l0x_err_t vl53l0x_get_limit_check_current(vl53l0x_handle_t dev, vl53l0x_check_t check, fp1616_t* current);
...
vl53l0x_err_t vl53l0x_set_dmax_cal_params(vl53l0x_handle_t dev, uint16_t range_mm, fp1616_t signal_rate_rtn_mcps);
vl53l0x_err_t vl53l0x_get_dmax_cal_params(vl53l0x_handle_t dev, uint16_t* range_mm, fp1616_t* signal_rate_rtn_mcps);

vl53l0x_err_t vl53l0x_perform_single_meas(vl53l0x_handle_t dev);
vl53l0x_err_t vl53l0x_perform_ref_calibration(vl53l0x_handle_t dev, uint8_t* vhv_settings, uint8_t* phase_cal);
vl53l0x_err_t vl53l0x_perform_xtalk_meas(vl53l0x_handle_t dev,
                                         uint32_t timeout_ms,
                                         fp1616_t* xtalk_per_spad,
                                         bool* ambient_too_high);
vl53l0x_err_t vl53l0x_perform_xtalk_calibration(vl53l0x_handle_t dev,
                                                fp1616_t xtalk_cal_distance,
                                                fp1616_t* xtalk_compensation_rate_mcps);
vl53l0x_err_t vl53l0x_perform_offset_calibration(vl53l0x_handle_t dev, fp1616_t cal_dist_mm, int32_t* offset_um);
...
vl53l0x_err_t vl53l0x_get_ranging_meas_data(vl53l0x_handle_t dev, vl53l0x_ranging_meas_data_t* data);
vl53l0x_err_t vl53l0x_get_hist_meas_data(vl53l0x_handle_t dev, vl53l0x_hist_meas_data_t* data);

vl53l0x_err_t vl53l0x_perform_single_ranging_meas(vl53l0x_handle_t dev, vl53l0x_ranging_meas_data_t* data);
vl53l0x_err_t vl53l0x_perform_single_hist_meas(vl53l0x_handle_t dev, vl53l0x_hist_meas_data_t* data);
...
vl53l0x_err_t vl53l0x_set_interrupt_threshold(vl53l0x_handle_t dev,
                                              vl53l0x_dev_mode_t mode,
                                              fp1616_t threshold_low,
                                              fp1616_t threshold_high);
vl53l0x_err_t vl53l0x_get_interrupt_threshold(vl53l0x_handle_t dev,
                                              vl53l0x_dev_mode_t mode,
                                              fp1616_t* threshold_low,
                                              fp1616_t* threshold_high);
...
vl53l0x_err_t vl53l0x_perform_ref_spad_management(vl53l0x_handle_t dev, uint32_t* count, bool aperture);
